...
module.exports = {
  ...
  version : function(_type, dontNeedStandalone){
    ...
    npm.load(pkgConfig, function(){
      ...
      npm.commands.view([pkgConfig.name, "version"],function(err, data){
        ...
        fs.writeFile(path.join(CWD, PACKAGE_JSON), JSON.stringify(pkgConfig, null, 4), function(err){
          !dontNeedStandalone && self.standalone(); //用新版本作为路径打出standalone
          if(err) throw err;
  ...
  standalone: function(){
    console.log('using builtin webpack config');
    var webpack = require("webpack");
    webpack(require('./standalone/webpack.config'), function(err, stats) {
